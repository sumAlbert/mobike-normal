        ...
        if(handing_num >= 0){
            try {
                ...
                for(int i=0;i<jsonArray.size();i++){
                    ...
                    String sql="insert into shanghai_address_info (lng,lat,province,city,district,street,streetNumber) values (\""+lng+"\",\""+lat+"\",\""+province+"\",\""+city+"\",\""+district+"\",\""+street+"\",\""+streetNumber+"\")";
